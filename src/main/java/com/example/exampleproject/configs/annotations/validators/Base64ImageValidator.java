 ...
 * This validator can be configured to accept specific image types.
 */
@Slf4j
public class Base64ImageValidator implements ConstraintValidator<Base64ImageValidation, String> {

    private static final Pattern BASE64_IMAGE_PATTERN = Pattern.compile("^data:image/[a-zA-Z0-9.+-]+;base64,.*");
