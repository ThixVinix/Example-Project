...
/**
 * Tests for {@link MultipartFileValidator}.
 */
...
class MultipartFileValidatorTest {
    ...
    void isValid_WhenValidJpegFile_ThenShouldReturnTrue() {
        assertTrue(multipartFileValidator.isValid(VALID_JPEG_FILE, context),
                "isValid should return true for a valid JPEG file");
    }
    ...
    void isValid_WhenNullValue_ThenShouldReturnTrue() {
        assertTrue(multipartFileValidator.isValid(null, context), "isValid should return true for a null value");
    }
    ...
    void isValid_WhenEmptyFile_ThenShouldReturnTrue() {
        ...
        assertTrue(multipartFileValidator.isValid(emptyFile, context), "isValid should return true for an empty file");
    }
    ...
    void isValid_WhenFileSizeExceedsLimit_ThenShouldReturnFalse() throws Exception {
        ...
        boolean exceedsLimit = (boolean) validateFileSizeMethod.invoke(
                ...
                context,
                MultipartFileMessageKeys.INVALID_SIZE);

        assertFalse(capturedMessages.isEmpty(), "A constraint violation should have been captured");
