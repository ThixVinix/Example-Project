...
class MessageCatalogCompletenessTest {
    ...
    private static final String BASENAME = "io/github/thixvinix/commons/files/spring/messages";

    @Test
    @DisplayName("Every MultipartFileMessageKeys constant resolves in the root, en and pt_BR bundles")
    ...
    private static List<String> declaredMessageKeys() throws IllegalAccessException {
        ...
        for (Field field : MultipartFileMessageKeys.class.getDeclaredFields()) {
