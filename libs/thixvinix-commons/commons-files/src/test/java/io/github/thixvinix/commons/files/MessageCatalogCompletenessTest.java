...
class MessageCatalogCompletenessTest {
    ...
    private static final String BASENAME = "io/github/thixvinix/commons/files/messages";

    @Test
    @DisplayName("Every FileMessageKeys constant resolves in the root, en and pt_BR bundles")
    ...
    private static List<String> declaredMessageKeys() throws IllegalAccessException {
        ...
        for (Field field : FileMessageKeys.class.getDeclaredFields()) {
