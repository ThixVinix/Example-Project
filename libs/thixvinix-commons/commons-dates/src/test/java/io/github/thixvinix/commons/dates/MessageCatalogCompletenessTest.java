...
class MessageCatalogCompletenessTest {
    ...
    private static final String BASENAME = "io/github/thixvinix/commons/dates/messages";

    @Test
    @DisplayName("Every DateMessageKeys constant resolves in the root, en and pt_BR bundles")
    ...
    private static List<String> declaredMessageKeys() throws IllegalAccessException {
        ...
        for (Field field : DateMessageKeys.class.getDeclaredFields()) {
